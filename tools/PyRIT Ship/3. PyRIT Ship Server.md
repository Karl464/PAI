...
- **Python 3.11.x**  
  📥 [Download Python 3.11.9 – Official Release](https://www.python.org/downloads/release/python-3119/)  
...
> 📌 Pinning `pyrit` to version **0.9.0** ensures compatibility with the tested setup.
...
### 5️⃣ Update the PyRIT Initialization Function
...
![PyRIT-Ship-Server](imgs/PyRIT-Ship-Server.png)
...
- **Troubleshooting tips**:  
  ...
  - DuckDB can fail on low memory machines use a laptop with enough RAM.
